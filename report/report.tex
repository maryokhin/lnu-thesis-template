...
%----------------------------------------------------------------------------------------
\begin{abstract}
\noindent The report can have a summary or an abstract. An abstract is a more scientific way to
...
\begin{itemize}
	...
	\item What was the problem? Why is it interesting and important to study this specific problem?
